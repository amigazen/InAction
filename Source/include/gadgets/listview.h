...
#define LIST_HookSub (LIST_Dummy+17)
#define LIST_HookEdit (LIST_Dummy+18)
#define LIST_HookDraw (LIST_Dummy+19)
#define LIST_ColumnsPos (LIST_Dummy+20)

/* Hook callback constants */
#define TLV_OPENSUB 1
#define TLV_CLOSESUB 2
#define TLV_DOEDIT 3
#define TLV_EDIT 4
#define TLV_DRAW 5
